...
; TrainerTypes bits (see engine/battle/read_trainer_party.asm)
	...
	const TRAINERTYPE_PAD_5_F
	const TRAINERTYPE_PAD_6_F
	const TRAINERTYPE_PERSONALITY_F ; 7
...
TRAINERTYPE_PAD_5       EQU 1 << TRAINERTYPE_PAD_5_F
TRAINERTYPE_PAD_6       EQU 1 << TRAINERTYPE_PAD_6_F
TRAINERTYPE_PERSONALITY EQU 1 << TRAINERTYPE_PERSONALITY_F
