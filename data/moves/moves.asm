...
; entries correspond to constants/move_constants.asm
	...
	move SCRATCH,      EFFECT_NORMAL_HIT,         40, NORMAL,   100, 35,   0 ; remove
	move VICEGRIP,     EFFECT_NORMAL_HIT,         55, NORMAL,   100, 30,   0 ; remove
	...
	move BIND,         EFFECT_TRAP_TARGET,        15, NORMAL,    75, 20,   0 ; remove
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,    75, 20,   0 ; remove?
	...
	move TAIL_WHIP,    EFFECT_DEFENSE_DOWN,        0, NORMAL,   100, 30,   0 ; remove?
	...
	move PECK,         EFFECT_NORMAL_HIT,         35, FLYING,   100, 35,   0 ; remove
	...
	move SELFDESTRUCT, EFFECT_SELFDESTRUCT,      200, NORMAL,   100,  5,   0 ; remove
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        35, WATER,     75, 10,   0 ; remove
	move SWIFT,        EFFECT_ALWAYS_HIT,         60, NORMAL,   100, 20,   0
	move SKULL_BASH,   EFFECT_SKULL_BASH,        100, NORMAL,   100, 15,   0
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          20, NORMAL,   100, 15,   0 ; remove
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          85, FIGHTING,  90, 20,   0 ; remove
	...
	move BARRAGE,      EFFECT_MULTI_HIT,          15, STEEL,     85, 20,   0
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          20, BUG,      100, 15,   0
	move LOVELY_KISS,  EFFECT_SLEEP,               0, FAIRY_T,   75, 10,   0
	...
	move SPLASH,       EFFECT_SPLASH,             10, NORMAL,   100, 40,   0
	...
	move FURY_SWIPES,  EFFECT_MULTI_HIT,          18, NORMAL,    80, 15,   0 ; remove
	...
	move SWEET_KISS,   EFFECT_CONFUSE,             0, FAIRY_T,   75, 10,   0
	...
	move CHARM,        EFFECT_ATTACK_DOWN_2,       0, FAIRY_T,  100, 20,   0
	...
	move VITAL_THROW,  EFFECT_VITAL_THROW,        70, FIGHTING, 100, 10,   0
	move MORNING_SUN,  EFFECT_MORNING_SUN,         0, NORMAL,   100,  5,   0
	move SYNTHESIS,    EFFECT_SYNTHESIS,           0, GRASS,    100,  5,   0
	move MOONLIGHT,    EFFECT_MOONLIGHT,           0, FAIRY_T,  100,  5,   0
	...
	move CRUNCH,       EFFECT_DEF_DOWN_HIT,       80, DARK,     100, 15,  20
