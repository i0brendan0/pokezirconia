	...
	tilecoll FLOOR, FLOOR, ROCKY_WALL, WALL ; 34
	...
	tilecoll WARP_CARPET_LEFT, FLOOR, WARP_CARPET_LEFT, FLOOR ; 39
	tilecoll FLOOR, COUNTER, FLOOR, COUNTER ; 3a
	tilecoll COUNTER, FLOOR, COUNTER, FLOOR ; 3b
